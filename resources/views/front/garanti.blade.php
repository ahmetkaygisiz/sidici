            ...
            <div class="movie-browse-agile">
                <div class="browse-agile-w3ls general-w3ls">
                    <div class="tittle-head">
                        <h4 class="latest-text">Garanti Politikamız </h4>
                        <div class="container">
                            <ul style="list-style-type:none;">
                                <li  style="font-size: 17px">
                                    Mağazamızda verilen tüm servisler ve sidici.com adresinde kayıtlı <b>Sidici.Şti.</b> firmamıza aittir ve firmamız tarafından işletilir.
                                ...
                                <li  style="font-size: 17px">
                                    <b>MAİL ORDER KREDİ KART BİLGİLERİ GÜVENLİĞİ</b><br>
                                ...
                                <li  style="font-size: 17px">
                                    <b>ÜÇÜNCÜ TARAF WEB SİTELERİ VE UYGULAMALAR</b><br>
                                ...
                                <li  style="font-size: 17px">
                                   <b> TARAYICI ÇEREZLERİ</b><br>
                                    ...
                                    Gizlilik politikamız ile ilgili her türlü soru ve önerileriniz için sidici@gmail.com adresine email gönderebilirsiniz. Firmamız’a ait aşağıdaki iletişim bilgilerinden ulaşabilirsiniz.

                                </li>
                            </ul>
                        </div>
                        <h4 class="latest-text">İade Politikamız </h4>
                        <div class="container">
                            <ul style="list-style-type:none;">
